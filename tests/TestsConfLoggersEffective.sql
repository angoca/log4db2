...
DECLARE RAISED_LG0E6 BOOLEAN DEFAULT FALSE; -- No duplicates.
...
DECLARE CONTINUE HANDLER FOR SQLSTATE 'LG0E5'
  ...
  END;
DECLARE CONTINUE HANDLER FOR SQLSTATE 'LG0E6'
  BEGIN
   INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (5, 'SQLState ' || SQLSTATE);
   SET RAISED_LG0E6 = TRUE;
  END;
...
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID) VALUES
  ('test12', EXPECTED_PARENT, EXPECTED_LEVEL);
IF (RAISED_LG0E6 = FALSE) THEN
 INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (2, 'Exception not raised');
ELSE
 INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (5, 'Exception raised LG0E6');
END IF;
SET RAISED_LG0E6 = FALSE;
COMMIT;
...
SET EXPECTED_LOGGER = LAST_VALUE + 13;
SET EXPECTED_PARENT = 0;
SET EXPECTED_LEVEL = 3; -- Default level
SET ACTUAL_PARENT = 0;
SET ACTUAL_LEVEL = -1;
...
SET EXPECTED_LOGGER = LAST_VALUE + 16;
SET EXPECTED_PARENT = 0;
SET EXPECTED_LEVEL = 3; -- Default level
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID) VALUES
...
-- Test17: Inserts a logger as ROOT.
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (3, 'Test17: Inserts a logger as ROOT');
SET ACTUAL_LOGGER = 1;
SET ACTUAL_PARENT = NULL;
SET ACTUAL_LEVEL = 3; -- Default level
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (LOGGER_ID, NAME, PARENT_ID, LEVEL_ID) VALUES
...
SET EXPECTED_LOGGER = LAST_VALUE + 17;
SET EXPECTED_PARENT = 0;
SET EXPECTED_LEVEL = 3; -- Default level
SET ACTUAL_LEVEL = 10;
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID) VALUES
...
SET EXPECTED_LOGGER = LAST_VALUE + 24;
SET EXPECTED_PARENT = 0;
SET EXPECTED_LEVEL = 3; -- Default level
SET ACTUAL_PARENT = 0;
SET ACTUAL_LEVEL = 3;
...
SET EXPECTED_LOGGER = LAST_VALUE + 32;
SET EXPECTED_PARENT = 0;
SET EXPECTED_LEVEL = 3; -- Default level
SET ACTUAL_PARENT = 0;
SET ACTUAL_LEVEL = 3;
