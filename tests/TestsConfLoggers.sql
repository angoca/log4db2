...
-- Test32: Tests to refresh effective when root inserted.
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (4, 'Test32: Tests to refresh effective when root inserted');
SET EXPECTED_LEVEL = 5;
DELETE FROM LOGDATA.CONF_LOGGERS;
DELETE FROM LOGDATA.CONF_LOGGERS_EFFECTIVE WHERE LOGGER_ID <> 0;
UPDATE LOGDATA.CONFIGURATION
...
-- Test33: Tests to refresh effective when root modified.
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (4, 'Test33: Tests to refresh effective when root modified');
SET EXPECTED_LEVEL = 4;
DELETE FROM LOGDATA.CONF_LOGGERS;
DELETE FROM LOGDATA.CONF_LOGGERS_EFFECTIVE WHERE LOGGER_ID <> 0;
UPDATE LOGDATA.CONFIGURATION
...
-- Test34: Tests to refresh effective when logger inserted.
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (4, 'Test34: Tests to refresh effective when logger inserted');
SET EXPECTED_LEVEL = 1;
DELETE FROM LOGDATA.CONF_LOGGERS;
DELETE FROM LOGDATA.CONF_LOGGERS_EFFECTIVE WHERE LOGGER_ID <> 0;
UPDATE LOGDATA.CONFIGURATION
...
INSERT INTO LOGDATA.CONF_LOGGERS (LOGGER_ID, NAME, PARENT_ID, LEVEL_ID)
  VALUES (0, 'ROOT', NULL, NULL);
INSERT INTO LOGDATA.CONF_LOGGERS (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('Test34', 0, EXPECTED_LEVEL);
SELECT LEVEL_ID INTO ACTUAL_LEVEL
  FROM LOGDATA.CONF_LOGGERS_EFFECTIVE
  WHERE NAME = 'Test34';
IF (EXPECTED_LEVEL <> ACTUAL_LEVEL) THEN
...
-- Test35: Tests to refresh effective when logger modified.
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (4, 'Test35: Tests to refresh effective when logger modified');
...
-- Test36: Tests to refresh effective in cascade.
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (4, 'Test36: Tests to refresh effective in cascade');
SET EXPECTED_LEVEL = 2;
DELETE FROM LOGDATA.CONF_LOGGERS;
DELETE FROM LOGDATA.CONF_LOGGERS_EFFECTIVE WHERE LOGGER_ID <> 0;
UPDATE LOGDATA.CONFIGURATION
...
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test36a', 0, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test36b', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID)
  VALUES ('test36c', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ);
INSERT INTO LOGDATA.CONF_LOGGERS (LOGGER_ID, NAME, PARENT_ID, LEVEL_ID)
  VALUES (0, 'ROOT', NULL, NULL);
INSERT INTO LOGDATA.CONF_LOGGERS (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test36a', 0, EXPECTED_LEVEL);
SELECT LEVEL_ID INTO ACTUAL_LEVEL
  FROM LOGDATA.CONF_LOGGERS_EFFECTIVE
  WHERE NAME = 'test36a';
IF (EXPECTED_LEVEL <> ACTUAL_LEVEL) THEN
...
-- Test37: Tests to refresh effective in cascade when root.
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (4, 'Test37: Tests to refresh effective in cascade when root');
SET EXPECTED_LEVEL = 1;
DELETE FROM LOGDATA.CONF_LOGGERS;
DELETE FROM LOGDATA.CONF_LOGGERS_EFFECTIVE WHERE LOGGER_ID <> 0;
UPDATE LOGDATA.CONFIGURATION
...
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test37a', 0, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test37b', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID)
  VALUES ('test37c', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ);
INSERT INTO LOGDATA.CONF_LOGGERS (LOGGER_ID, NAME, PARENT_ID, LEVEL_ID)
  VALUES (0, 'ROOT', NULL, EXPECTED_LEVEL);
SELECT LEVEL_ID INTO ACTUAL_LEVEL
  FROM LOGDATA.CONF_LOGGERS_EFFECTIVE
...
-- Test38: Tests nothing when inserted root with null
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (4, 'Test38: Tests nothing when inserted root with null');
SET EXPECTED_LEVEL = 3;
SET ACTUAL_LEVEL = NULL;
DELETE FROM LOGDATA.CONF_LOGGERS;
DELETE FROM LOGDATA.CONF_LOGGERS_EFFECTIVE WHERE LOGGER_ID <> 0;
...
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test38a', 0, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test38b', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID)
  VALUES ('test38c', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ);
INSERT INTO LOGDATA.CONF_LOGGERS (LOGGER_ID, NAME, PARENT_ID, LEVEL_ID)
...
-- Test39: Tests nothing when modified root with null
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (4, 'Test39: Tests nothing when modified root with null');
SET EXPECTED_LEVEL = 3;
SET ACTUAL_LEVEL = NULL;
DELETE FROM LOGDATA.CONF_LOGGERS;
DELETE FROM LOGDATA.CONF_LOGGERS_EFFECTIVE WHERE LOGGER_ID <> 0;
...
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test39a', 0, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test39b', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID)
  VALUES ('test39c', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ);
INSERT INTO LOGDATA.CONF_LOGGERS (LOGGER_ID, NAME, PARENT_ID, LEVEL_ID)
...
-- Test40: Tests only root modified with other level defined
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (4, 'Test40: Tests only root modified with other level defined');
SET EXPECTED_LEVEL = 2;
SET ACTUAL_LEVEL = NULL;
DELETE FROM LOGDATA.CONF_LOGGERS;
DELETE FROM LOGDATA.CONF_LOGGERS_EFFECTIVE WHERE LOGGER_ID <> 0;
...
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test40a', 0, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test40b', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID)
  VALUES ('test40c', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ);
INSERT INTO LOGDATA.CONF_LOGGERS (LOGGER_ID, NAME, PARENT_ID, LEVEL_ID)
  VALUES (0, 'ROOT', NULL, 1);
INSERT INTO LOGDATA.CONF_LOGGERS (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test40a', 0, 2);
...
-- Test41: Tests only root modified with other level with null
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (4, 'Test41: Tests only root modified with other level with null');
SET EXPECTED_LEVEL = 4;
SET ACTUAL_LEVEL = NULL;
DELETE FROM LOGDATA.CONF_LOGGERS;
DELETE FROM LOGDATA.CONF_LOGGERS_EFFECTIVE WHERE LOGGER_ID <> 0;
...
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test41a', 0, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test41b', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID)
  VALUES ('test41c', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ);
INSERT INTO LOGDATA.CONF_LOGGERS (LOGGER_ID, NAME, PARENT_ID, LEVEL_ID)
  VALUES (0, 'ROOT', NULL, 1);
INSERT INTO LOGDATA.CONF_LOGGERS (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test41a', 0, NULL);
UPDATE LOGDATA.CONF_LOGGERS
  SET LEVEL_ID = EXPECTED_LEVEL
  WHERE LOGGER_ID = 0;
SELECT LEVEL_ID INTO ACTUAL_LEVEL
...
-- Test42: Tests only root modified with defined sublevel
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (4, 'Test42: Tests only root modified with defined sublevel');
SET EXPECTED_LEVEL = 4;
SET ACTUAL_LEVEL = NULL;
DELETE FROM LOGDATA.CONF_LOGGERS;
DELETE FROM LOGDATA.CONF_LOGGERS_EFFECTIVE WHERE LOGGER_ID <> 0;
...
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test42a', 0, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test42b', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ, 4);
INSERT INTO LOGDATA.CONF_LOGGERS_EFFECTIVE (NAME, PARENT_ID)
  VALUES ('test42c', PREVIOUS VALUE FOR LOGDATA.LOGGER_ID_SEQ);
INSERT INTO LOGDATA.CONF_LOGGERS (LOGGER_ID, NAME, PARENT_ID, LEVEL_ID)
  VALUES (0, 'ROOT', NULL, 1);
INSERT INTO LOGDATA.CONF_LOGGERS (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test42a', 0, NULL);
SELECT LOGGER_ID INTO ACTUAL_LOGGER
  FROM LOGDATA.CONF_LOGGERS_EFFECTIVE
  WHERE NAME = 'test42a';
INSERT INTO LOGDATA.CONF_LOGGERS (NAME, PARENT_ID, LEVEL_ID)
  VALUES ('test42b', ACTUAL_LOGGER, 2);
UPDATE LOGDATA.CONF_LOGGERS
  SET LEVEL_ID = EXPECTED_LEVEL
  WHERE LOGGER_ID = 0;
SELECT LEVEL_ID INTO ACTUAL_LEVEL
...
-- Test43: Inserts a ROOT logger with null level.
INSERT INTO LOGDATA.LOGS (LEVEL_ID, MESSAGE) VALUES (3, 'Test43: Inserts a ROOT logger with null level');
DELETE FROM LOGDATA.CONF_LOGGERS;
DELETE FROM LOGDATA.CONF_LOGGERS_EFFECTIVE WHERE LOGGER_ID <> 0;
SET EXPECTED_LOGGER = 0;
SET EXPECTED_PARENT = NULL;
